...
public class TimePickerDialog extends DialogFragment implements RadialPickerLayout.OnValueSelectedListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mRed = res.getColor(R.color.red_normal);
        mRedLight = res.getColor(R.color.red_light);
    ...
    private void setCurrentItemShowing(int index, boolean animateCircle, boolean delayLabelAnimate,
        ...
        int hourColor = (index == HOUR_INDEX) ? mWhite : mRedLight;
        int minuteColor = (index == MINUTE_INDEX) ? mWhite : mRedLight;
    ...
    private void updateDisplay(boolean allowEmptyDisplay) {
        if (!allowEmptyDisplay && mTypedTimes.isEmpty()) {
            ...
            mHourView.setTextColor(mRedLight);
            mMinuteView.setText(minuteStr);
            mMinuteSpaceView.setText(minuteStr);
            mMinuteView.setTextColor(mRedLight);
            if (!mIs24HourMode) {
