...
public class SimpleMonthView extends View {
	...
	public SimpleMonthView(Context context) {
		...
		mDayTextColor = resources.getColor(R.color.black);
		mTodayNumberColor = resources.getColor(R.color.red_normal);
		mMonthTitleColor = resources.getColor(R.color.black);
		mMonthTitleBGColor = resources.getColor(R.color.white);
